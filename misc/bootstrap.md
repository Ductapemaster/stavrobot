...
4. If and ONLY if the user explicitly approves, follow the skill's instructions. After completing them, record the skill in the `skills` table with its name, URL, full content, and version.
